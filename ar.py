...
logo = ''' \033[0;96m   ___    ___    ____   
 ...
 \033[1;93m/ \033[0;91mv2.0 \033[0m| Facebook.com/artermuxtrick
...
def yayanxd():
    ...
    try:
        ...
        print '%s╠══[%s FOLLOW MY FB PAGE Ar Termux Trick  Ya:v \033[0;96m]'%(O,N);time.sleep(2)
        open('.memek.txt', 'w').write(kontol)
        raw_input('\n%s[•]%s Press Enter '%(O,N));wuhan(kontol)
        os.system('xdg-https://www.facebook.com/profile.php?id=100065434664869/')
        moch_yayan()
    except KeyError:
...
def info_tools():
    ...
    print '%s[%s>%s] Facebook : https://www.facebook.com/profile.php?id=100065434664869/'%(N,H,N);time.sleep(0.09)
    print '%s[%s>%s] watsapp: https://wa.me/+923455593875'%(N,H,N);time.sleep(0.09)
    print '%s[%s#%s]'%(N,O,N), 52 * '\x1b[1;96m-\x1b[0m';time.sleep(0.09)
